...
((SELECT dog_id FROM Dogs WHERE name = 'Balle' LIMIT 1), '2025-07-10 08:00:00', '45', 'Moon', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name = 'PhuLoc' LIMIT 1), '2025-04-10 08:00:00', '100', 'Renown Park', 'completed'),
((SELECT dog_id FROM Dogs WHERE name = 'LuongPhuoc' LIMIT 1), '2025-06-10 08:00:00', '20', 'Fuji', 'open'),