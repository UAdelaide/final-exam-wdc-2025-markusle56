...
((SELECT dog_id FROM Dogs WHERE name = 'Max' LIMIT 1), '2025-06-10 09:30:00', '45', 'Beachside Ave', 'accepted'),
...
((SELECT dog_id FROM Dogs WHERE name = 'Max' LIMIT 1), '2025-06-10 08:00:00', '30', 'Fuji', 'open'),